...
import matplotlib.ticker as ticker  # <-- Importante para formatear el eje Y lineal
...
axs[0].legend()
# axs[0].set_yscale('log') # <-- MODIFICADO: Removido escala logarítmica
...
axs[4].legend()
# axs[4].set_yscale('log') # <-- MODIFICADO: Removido escala logarítmica
axs[4].grid(True, which="both", ls="--", alpha=0.5)


# 5. Configurar de forma individual las marcas del eje X e Y para los 5 subplots
...
plt.savefig('grafico_rendimiento_segundos_lineal.png', dpi=300)
plt.show()